        ...
        client.on('session', (accept, reject) => {
          ...
          session.on('sftp', (accept, reject) => {
            ...
            sftpStream.on('OPEN', (reqid, filename, flags, attrs) => {
              this._log(util.format('SFTP OPEN filename=%s flags=%s handle=%d', filename, SFTPStream.flagsToString(flags), handleCount));
              ...
              this._log(util.format('SFTP CLOSE handle=%d', handle));
